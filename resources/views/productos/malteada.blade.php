...
<head>
    ...
    <title>Malteadas de Chocolate</title>
...
<body class="bg-light">
    ...
    <div class="container mt-5">
        <h1 class="text-center mb-4">Malteadas de Chocolate</h1>

        <div class="comidas-apiladas">
            @forelse($productos as $producto)
            <div class="mb-4">
                <div class="card shadow-sm">
                    <img src="{{ asset($producto->imagen) }}" class="img-pequena" alt="Imagen del producto" />
                    <div class="card-body">
